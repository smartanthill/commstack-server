...
#define HAL_GET_PACKET_BYTES( packet_handle ) debug_try_get_message_within_master( packet_handle )
#define HAL_SEND_PACKET_TO_DEVICE( packet_handle ) debug_send_message( packet_handle )
...
#define HAL_GET_PACKET_BYTES( packet_handle ) try_get_message_within_master( packet_handle )
#define HAL_SEND_PACKET_TO_DEVICE( packet_handle ) send_message( packet_handle )
